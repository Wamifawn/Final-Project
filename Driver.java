...
{
  private PriorityQueue<Department> departmentPQ = new PriorityQueue<>(); /* priority queue of departments */
  ...
  public Department( String fileName ){
    /* Open the fileName, create items based on the contents, and add those items to itemsDesired */
	  ...
	  try {
		  ...
		  e.printStackTrace();
		  System.out.println("The file "+ fileName+" was not found."); return;
	  }
